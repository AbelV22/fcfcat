  ...
  return (
    <div className="flex flex-col items-center">
      <svg viewBox="0 0 180 130" className="w-48 h-auto">
        ...
        <text x={cx} y={cy - 5} textAnchor="middle" className="text-3xl font-black" fill="white" fontSize="28">{clampedScore}</text>
...
function RadialPercentile({ value, label, sublabel, size = 90 }: { value: number; label: string; sublabel?: string; size?: number }) {
  const r = (size - 10) / 2
  ...
  return (
    <div>
      <div className="flex justify-between text-xs mb-1.5">
        <span className="text-slate-400">{leftLabel} <span className="font-bold" style={{ color: leftColor }}>{left}</span></span>
        <span className="text-slate-400"><span className="font-bold" style={{ color: rightColor }}>{right}</span> {rightLabel}</span>
      </div>
          ...
          <div className="space-y-5">
            ...
            <div className="glass-card rounded-2xl p-6 border-purple-500/20">
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-5">
                <div className="flex items-center gap-4 flex-1 min-w-0">
                  ...
                  <div className="min-w-0">
                    ...
                    <div className="flex items-center gap-2 text-sm text-slate-400">
                      <span>{ref.matches} partits (senior)</span>
                ...
                <SeverityGauge score={ref.severity_score} />
              </div>
            </div>
              ...
              <div className="glass-card rounded-2xl p-6 border-blue-500/15">
                ...
                <div className="flex items-center justify-center gap-8 sm:gap-12">
                  <div className="relative">
                    <RadialPercentile value={ref.division_yellows_percentile} label="Grogues" sublabel={`a ${ref.division_name}`} size={100} />
                  </div>
                  <div className="relative">
                    <RadialPercentile value={ref.division_reds_percentile} label="Vermelles" sublabel={`a ${ref.division_name}`} size={100} />
                  </div>
                </div>
            ...
            <div className="glass-card rounded-2xl p-6">
              ...
              <div className="flex items-center justify-center gap-8 sm:gap-12">
                <div className="relative">
                  <RadialPercentile value={ref.yellows_percentile} label="Grogues" size={100} />
                </div>
                <div className="relative">
                  <RadialPercentile value={ref.reds_percentile} label="Vermelles" size={100} />
                </div>
              </div>
            </div>
              ...
              <div className="glass-card rounded-2xl p-5">
                ...
                <div className="space-y-3">
                  ...
                  <SplitBar
                    ...
                    leftColor="#ef4444" rightColor="#f87171"
                  />
                  <div className="flex items-center justify-between text-[10px] text-slate-500 pt-2 border-t border-white/8">
                  ...
                  {ref.recentMatches.slice(0, 10).map((m, i) => {
                    ...
                    return (
                      <div key={i} className={`flex items-center gap-3 text-sm py-2 border-b border-white/5 last:border-0 ${isCoachDiv ? 'bg-blue-500/5 rounded-lg px-2 -mx-2' : ''}`}>
                        ...
                        <span className="font-bold tabular-nums text-slate-300 shrink-0">
