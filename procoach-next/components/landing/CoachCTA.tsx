...
export default function CoachCTA() {
  return (
    <section className="max-w-4xl mx-auto px-4 sm:px-6 mb-32 reveal">
      <div className="relative rounded-lg overflow-hidden pitch-texture">
        {/* Background layers */}
        <div className="absolute inset-0 bg-gradient-to-br from-emerald-950/70 via-[#0f1f35] to-[#08090a]" />
        <div className="absolute inset-0 border border-white/[0.09] rounded-lg" />
        {/* Ambient glow */}
        <div className="absolute top-0 right-0 w-96 h-96 bg-emerald-500/6 rounded-full blur-3xl" />
        <div className="absolute bottom-0 left-0 w-64 h-64 bg-[#22c55e]/4 rounded-full blur-3xl" />
        {/* Top accent */}
        ...
        <div className="relative z-10 p-8 sm:p-12 lg:p-16 text-center">
          ...
          <p className="text-[#8a8f98] mb-10 leading-relaxed text-sm sm:text-base max-w-lg mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link
              ...
              className="inline-flex items-center justify-center gap-2 px-8 py-5 border border-white/[0.12]
                         hover:bg-white/5 text-[#d0d6e0] hover:text-white font-medium rounded-lg transition-all text-base"
            >
              Ja tinc compte
            </Link>
          </div>
